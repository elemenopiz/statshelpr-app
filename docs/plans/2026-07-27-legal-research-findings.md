...
The rewrite made exposure **broader**, not narrower — the opposite of what the jurisdictional question was testing for. Quotations below are **first-source verbatim**, read directly from the current chapter PDF (footer-stamped `09/18/25`), not relayed:

- **Sec. 11-102(c) — the change that costs the most.** Old text reached off-campus conduct only when "in connection with an institution-oriented activity" or "sponsored by or affiliated with the University" — a private commercial side business is neither, so there was a real argument Chapter 11 didn't reach it. New text: *"The provisions of this rule cover conduct occurring on campus, as well as conduct occurring off-campus when the conduct substantially affects a person's education or employment with the University or poses a risk of harm to members of the University community."* That argument is gone.
- **Sec. 11-102(e) — non-prosecution buys nothing.** *"Proceedings under this Chapter may be carried out prior to, simultaneously with, or following, or in the absence of criminal proceedings. Disciplinary decisions and sanctions imposed under this Chapter will not be subject to change based upon the outcome of criminal charges or decisions."* § 32.50 having never been prosecuted is therefore irrelevant to a UT proceeding. Sec. 11-102(b) independently makes violating "federal, state, or local laws" a basis for discipline at the jurisdictional level.
- **Sec. 11-401(4) unauthorised aid.** *"providing aid or assistance to, or utilizing aid or assistance from, another individual **or source** without authorization, and pertaining to an academic assignment or course requirement."* No enrolment nexus — being outside STA 301 is not a defence. Giver and receiver independently chargeable. The added "**or source**" makes the tool itself an unauthorised source, which cleans up the *customer's* violation and thereby strengthens the case against the provider. (Old wording: "another student or individual, without authority, in conjunction with a test, project, or other assignment.")
- **Sec. 11-401(3) Unauthorized Materials — the instrument analogy is dead institutionally.** *"obtaining, accessing, or possessing materials without authorization, including but not limited to class notes, textbooks, calculators, **online resources**, and/or electronic devices."* The old "calculators, electronic devices" language survived **and gained "online resources."** The Wolfram/Photomath analogy that helps under § 32.50 does not help here.
- **Sec. 11-402(1).** *"any behavior that **may** violate any federal, state, or local law, ordinance, or regulation"* — note *may* violate, not violates. Imports § 32.50 into a UT proceeding at **preponderance**, no prosecution required. Possibly UT's easier route.
- **Sec. 11-402(11) Technology Misuse — not previously flagged.** *"engages in unauthorized access or entry into a computer, computer system, network, database, software, or data."* A UT-internal analogue of § 33.02 / CFAA decided at preponderance, without *Van Buren*'s limits. Bites users most directly, but it is live.
- **Sec. 11-102(g) — future rule changes apply to present conduct.** Procedure follows the Catalog "in effect on the day that an allegation of misconduct is referred to Student Conduct … not the date on which the alleged violation is noted to have occurred."
- **Collusion was narrowed** — old 11-402(e) covered "collaboration with another person to commit a violation of any section of the rules on academic dishonesty," which would have caught an arm's-length vendor. New Sec. 11-401(8) is only *"unauthorized collaboration with another student or students."* **The single change in the owner's favour, and it is moot** — 11-401(4) reaches him directly.
- **Procedure:** preponderance standard (Sec. 11-102(f), defined as "more likely to have occurred than not"); advisor may confer but "may not advocate"; sanctions to expulsion; appeal limited to three grounds — not disagreement with the finding; the 30-day referral rule (Sec. 11-507(e)) is a **recommendation** to faculty, not a limitations period. Sec. 11-300(23): *"individuals who are not currently enrolled at the University remain subject to the disciplinary process for conduct that occurred while they were enrolled."* Sec. 11-102(i) lets Student Conduct reopen on new information — no finality.

**Net: of eight substantive changes, one helps and it is redundant.**
